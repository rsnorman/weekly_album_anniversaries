...
ActiveRecord::Schema.define(version: 20171015015243) do
  ...
  add_index "fun_facts", ["album_id"], name: "index_fun_facts_on_album_id"
  ...
  add_index "scheduled_tweets", ["album_id"], name: "index_scheduled_tweets_on_album_id"
